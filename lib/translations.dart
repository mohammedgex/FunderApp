...
class Translation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'ar_EG': {
          ...
          "Save": "حفظ",
          // verify
          "Verify ID": "تأكيد الهوية",
          "We need to verify your ID": "نحتاج لتأكيد هويتك",
          "In order to create an account we need to be 100% sure you are you":
              "لانشاء حسابك نحتاج للتأكد انه انت بنسبة 100%.",
          "Verify": "تأكيد",

          //upload id
          "Upload your Passport": "رفع الهوية الخاصة بك",
          "Front Side": "الوجهة الامامي",
          "Back Side": "الوجهة الخلفي",
          // select id type
          "Select the type of document you wish to scan":
              "اختار نوع المستند المراد تقديمه",
          "we need to determine if an identity document is authentic and belongs to you":
              "نحتاج الي التأكد من المستند يخصك.",
          "Passport": "جواز السفر",
          "National ID": "بطاقة قومية",
        ...
        'en_US': {
          ...
          //upload id
          "Upload your Passport": "Upload your Passport",
