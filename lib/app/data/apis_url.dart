class ApiUrls {
  ...
  static const Verify_api = "$URl/api/user/verification";
  static const Properties_api = "$URl/api/properties";
  static const Identification_api = "$URl/api/user/identification";
  static const Favorites_api = "$URl/api/favorites";
  static const Search_api = "$URl/api/property/filter";
  static const Wallet_api = "$URl/api/wallet";
  ...
  static const MyProperties_api = "$URl/api/properties/shere/panding";
